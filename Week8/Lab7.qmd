...
print("Description/Summary Stats of Data")
print(ha.describe())
...
print("Output(Target Variable) Distribution for Male Patients")
print(malecount)
print("Output(Target Variable) Distribution for Female Patients")
print(femalecount)
